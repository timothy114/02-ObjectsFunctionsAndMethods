...
def main():
    ...
    #even_better_draw_circles((rg.Point(100, 50)), 20,5,'red',1)
    #even_better_draw_circles((rg.Point(-200, 0)), 10,10,'blue',5)

    p = -200
    for i in range(10):
        even_better_draw_circles(rg.Point(p,0),(5*i),i,'black',(10-i))
        p += 25
...
def even_better_draw_circles(point,increase,num_circles,color,thiccness):
    ...
    turtle.pen = rg.Pen(color,thiccness)
